...
def copy_config_files():
    ...
    if target_zshrc_path.exists():
        ...
        try: command_utils.run_command(["cp",str(target_zshrc_path),str(backup_zshrc_path)],as_user=shared_state.TARGET_USER)
    ...
    try: command_utils.run_command(["mkdir","-p",str(nanorc_config_dir)],as_user=shared_state.TARGET_USER)
    ...
    if target_nanorc_path.exists():
        ...
        try: command_utils.run_command(["cp",str(target_nanorc_path),str(backup_nanorc_path)],as_user=shared_state.TARGET_USER)
